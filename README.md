...
- 🌍 Ноды в Риге, Нидерландах и Финляндии под панелью **Remnawave**
- 🖧 Также использовались панели **3x-ui** на нескольких серверах
...
- 🔁 Прорабатывалась миграция с 3x-ui на Remnawave, включая настройку Hysteria2-ноды
- 💳 Проработаны варианты приёма платежей (в приоритете СБП), домен зарегистрирован через Porkbun
