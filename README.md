...
**Aegis** - роутеры с предустановленной прошивкой для обхода санкций и собственная серверная инфраструктура. Идея простая: не заставлять пользователя разбираться в протоколах, конфигах и отдельных приложениях на каждом устройстве - обход санкций зашивается один раз на уровне роутера, и дальше просто работает.
